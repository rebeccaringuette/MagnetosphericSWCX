...
source_list=np.array(['MSWCX6','MSWCX7','MSWCX8','MSWCX9'],dtype=str) 
# need HSWCX calcs for: 'MSWCX1','MSWCX2','MSWCX3','MSWCX11','MSWCX12'    mod2 done: 'MSWCX4','MSWCX5','MSWCX10'
ID_list = np.array([73,74,75,76],dtype=int)  #mod2 done: 71,72,77
#source_list, ID_list = np.array(('MSWCX5',''),dtype=str), np.array((72,0),dtype=int)  #correcting target 72 fit
spec_dir='/home/ringuette/halosat_sourceanalysis/MSWCX_2020Analysis/Rebinned_files_combined/' #directory where all spectra are stored
...
mod_choice = '2'
model_note = 'MSWCXTails_v15'+nH_type+'_mod'+mod_choice+'f'  #store choices, fit type

#set SWCX scaling factors
'''# Model 2 Lists
SWCX_scale = {'MSWCX4':np.array(['0.50','0.75','1.00','1.25','1.50'],dtype=str),\
              'MSWCX5':np.array(['0.50','0.75','1.00','1.25','1.50'],dtype=str),\
              'MSWCX6':np.array(['0.50','0.75','1.00','1.25','1.50'],dtype=str),\
              'MSWCX7':np.array(['0.50','0.75','1.00','1.25','1.50'],dtype=str),\
              'MSWCX8':np.array(['0.50','0.75','1.00','1.25','1.50'],dtype=str),\
              'MSWCX9':np.array(['0.50','0.75','1.00','1.25','1.50'],dtype=str),\
              'MSWCX10':np.array(['0.50','0.75','1.00','1.25','1.50'],dtype=str)}  #a_list

SWCX_scale = {'MSWCX4':np.array(['0.80','0.90','1.10','1.20'],dtype=str),\
              'MSWCX5':np.array(['1.10','1.20','1.30','1.40'],dtype=str),\
              'MSWCX6':np.array(['0.20','0.30','0.40'],dtype=str),\
              'MSWCX7':np.array(['1.60','1.70','1.80','1.90','2.00'],dtype=str),\
              'MSWCX8':np.array(['1.60','1.70','1.80','1.90','2.00'],dtype=str),\
              'MSWCX9':np.array(['1.60','1.70','1.80','1.90','2.00'],dtype=str),\
              'MSWCX10':np.array(['1.60','1.70','1.80','1.90','2.00'],dtype=str)}  #b_list

SWCX_scale = {'MSWCX4':np.array(['1.05','1.06','1.07','1.08','1.09','1.11','1.12','1.13','1.14'],dtype=str),\
              'MSWCX5':np.array(['1.15','1.16','1.17','1.18','1.19','1.21','1.22','1.23','1.24'],dtype=str),\
              'MSWCX6':np.array(['0.00','0.10'],dtype=str),\
              'MSWCX7':np.array(['2.50','3.00','3.50'],dtype=str),\
              'MSWCX8':np.array(['2.50','3.00','3.50'],dtype=str),\
              'MSWCX9':np.array(['2.50','3.00','3.50'],dtype=str),\
              'MSWCX10':np.array(['1.65','1.66','1.67','1.68','1.69','1.71','1.72','1.73','1.74'],dtype=str)}  #c_list
   
SWCX_scale = {'MSWCX4':np.array(['0.00','0.25','2.00','2.50','3.00','3.50'],dtype=str),\
              'MSWCX5':np.array(['0.00','0.25','1.75','2.00','2.50','3.00'],dtype=str),\
              'MSWCX6':np.array(['1.75','2.00','2.25','2.50','2.75','3.00'],dtype=str),\
              'MSWCX7':np.array(['4.00','4.50','5.00','5.50','6.00'],dtype=str),\
              'MSWCX8':np.array(['2.10','2.20','2.30','2.40','2.60','2.70','2.80','2.90'],dtype=str),\
              'MSWCX9':np.array(['4.00','4.50','5.00','5.50','6.00'],dtype=str),\
              'MSWCX10':np.array(['0.00','0.25','2.50','3.00','3.50','4.00','4.50','5.00'],dtype=str)}  #d_list      
 
SWCX_scale = {'MSWCX4':np.array(['2.10','2.20','2.30','2.40'],dtype=str),\
              'MSWCX5':np.array(['2.10','2.20','2.30','2.40'],dtype=str),\
              'MSWCX6':np.array(['2.10','2.20'],dtype=str),\
              'MSWCX7':np.array(['2.60','2.70','2.80','2.90','3.60','3.70','3.80','3.90',\
                                '4.10','4.20','4.30','4.40','4.60','4.70','4.80','4.90'],dtype=str),\
              'MSWCX8':np.array(['1.10','1.20','2.75','2.76','2.77','2.78','2.79',\
                                '2.81','2.82','2.83','2.84','4.00','4.50','5.00'],dtype=str),\
              'MSWCX9':np.array(['2.10','2.20','2.30','2.40','3.10','3.20','3.30',\
                                '3.40','3.60','3.70','3.80','3.90','4.10','4.20','4.30','4.40'],dtype=str),\
              'MSWCX10':np.array(['3.60','3.70','3.80','3.90'],dtype=str)}  #e_list      

SWCX_scale = {'MSWCX6':np.array(['0.01','0.05'],dtype=str),\
              'MSWCX7':np.array(['3.85','3.86','3.87','3.88','3.89','3.91','3.92','3.93','3.94'],dtype=str),\
              'MSWCX8':np.array(['3.60','3.70','3.80','3.90'],dtype=str),\
              'MSWCX9':np.array(['3.45','3.46','3.47','3.48','3.49','3.51','3.52','3.53','3.54'],dtype=str)}  #f_list  
'''
#Model 1 Lists
...
SWCX_LU = {}
SWCX_file = DictReader(open(code_dir+'Mod1n2HSWCXcalc.csv','r'))
...
for source_name in source_list:
    ...
    spec_list=np.sort(glob.glob(spec_dir+source_name+'_Tails_cl1_d*_rebin40.pi'))      #get file names
    obsname = spec_list[0].split('/')[-1].split('_')[1]   #retrieve obsname from first file

    #initialize output format
    file_header='Target,SWCX_scale,RA,DEC,GLon,Glat,LHB_N,'+nH_type.split('_')[1] #all other headers not hard-coded
    file_format='\n{0[0]},{0[1]},{0[2]:.6f},{0[3]:.6f},{0[4]:.6f},{0[5]:.6f},{0[6]:.6f},{0[7]:.6f}'
    csv_num=8  #next number in []
    #print source_name, SWCX_scale[source_name]

    for OVII_Oratio in SWCX_scale[source_name]:        
        #retrieve SWCX_LU values for current combined tail obs   
        idx = np.where(SWCX_LU['Field']==source_name+'_Tails')[0]
        if SWCX_LU['OVII_'+mod_choice][idx][0]=='': continue   #skip if no SWCX calculations available
        OVII_N = float(SWCX_LU['OVII_'+mod_choice][idx][0])*0.035*float(OVII_Oratio)
        OVIII_N = float(SWCX_LU['OVIII_'+mod_choice][idx][0])*0.035*float(OVII_Oratio)
        NeIX_N = float(SWCX_LU['NeIX_'+mod_choice][idx][0])*0.035*float(OVII_Oratio)    
        ...
        #store values
        halo_arr=[source_name,OVII_Oratio,RA[source_idx][0],DEC[source_idx][0],glon[source_idx][0],glat[source_idx][0],LHB[source_idx][0],nh[source_idx][0]]
        ...
        for i in range(len(spec_list)): #fit model to each spectrum linked between detectors        
            ...
            if OVII_Oratio==SWCX_scale[source_name][0]:
        ...
        logFile = xs.Xset.openLog(out_dir+model_note+str(np.where(SWCX_scale[source_name]==OVII_Oratio)[0][0])+'_'+source_name+'_xspeclog.txt')
        xs.Xset.show()
        xs.AllData.show()  
        ...
        while error_check>0:
            ...
            error_loop+=1
            logFile = xs.Xset.openLog(out_dir+model_note+str(np.where(SWCX_scale[source_name]==OVII_Oratio)[0][0])+'_'+source_name+'_xspeclog'+str(error_loop)+'.txt')
            xs.Xset.show()
            xs.AllData.show()  
            if (xs.Fit.statistic/xs.Fit.dof<2.):
                #run error on all free BKG parameters
        ...
        for i, j in itertools.product(range(len(spec_list)), range(smodel[i].nParameters)):
            if not ((smodel[i](j+1).frozen)or(len(smodel[i](j+1).link)>0)):
                ...
                if OVII_Oratio==SWCX_scale[source_name][0]:  #first key
        ...
        if OVII_Oratio==SWCX_scale[source_name][0]: #initialize csv file header
            file_header+=',X^2,dof,red_X^2'
            file_format+=',{0['+str(csv_num)+']:.6f},{0['+str(csv_num+1)+']},{0['\
                +str(csv_num+2)+']:.6f}'        
            chi_file=open(out_dir+model_note+'_'+source_name+'.csv','w') #initialize output file
            chi_file.write(file_header)
            chi_file.close()        
        
        #output results to csv file spec_dir
        with open(out_dir+model_note+'_'+source_name+'.csv','a') as chi_file: 
        ...
        xs.Plot.device = '/xs'    
        xs.Plot("data delchi")
        xs.Plot.device = out_dir+model_note+str(np.where(SWCX_scale[source_name]==OVII_Oratio)[0][0])+'_'+source_name+'_delchi.ps/cps' # save xspec version of plots
        xs.Plot("data delchi") 
        xs.Plot.device = '/null'
        #stop
