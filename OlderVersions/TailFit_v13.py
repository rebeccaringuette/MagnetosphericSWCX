...
source_list=np.array(('MSWCX9','MSWCX10','MSWCX11','MSWCX12'),dtype=str)  #done: 'MSWCX1','MSWCX2','MSWCX3','MSWCX4','MSWCX5','MSWCX8'
# need SWCX: 'MSWCX6','MSWCX7',
...
model_note = 'MSWCXTails_v13'+nH_type  #store choices, fit type
