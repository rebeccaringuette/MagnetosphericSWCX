...
mod_choice = '2'
model_note = 'MSWCXTails_v16'+nH_type+'_mod'+mod_choice+'e'  #store choices, fit type

#set SWCX scaling factors
'''# Model 2 Lists
SWCX_scale = {'MSWCX4':np.array(['0.00','0.50','1.00','1.50','2.00'],dtype=str),\
              'MSWCX5':np.array(['0.00','0.50','1.00','1.50','2.00'],dtype=str),\
              'MSWCX6':np.array(['0.00','0.50','1.00','1.50','2.00'],dtype=str),\
              'MSWCX7':np.array(['0.00','0.50','1.00','1.50','2.00'],dtype=str),\
              'MSWCX8':np.array(['0.00','0.50','1.00','1.50','2.00'],dtype=str),\
              'MSWCX9':np.array(['0.00','0.50','1.00','1.50','2.00'],dtype=str),\
              'MSWCX10':np.array(['0.00','0.50','1.00','1.50','2.00'],dtype=str)}  #a_list

SWCX_scale = {'MSWCX4':np.array(['1.10','1.20','1.30','1.40','1.60','1.70','1.80','1.90'],dtype=str),\
              'MSWCX5':np.array(['1.10','1.20','1.30','1.40','1.60','1.70','1.80','1.90'],dtype=str),\
              'MSWCX6':np.array(['2.50','3.00','3.50','4.00','4.50','5.00'],dtype=str),\
              'MSWCX7':np.array(['2.50','3.00','3.50','4.00','4.50','5.00'],dtype=str),\
              'MSWCX8':np.array(['1.10','1.20','1.30','1.40','1.60','1.70','1.80','1.90'],dtype=str),\
              'MSWCX9':np.array(['2.50','3.00','3.50','4.00','4.50','5.00'],dtype=str),\
              'MSWCX10':np.array(['0.60','0.70','0.80','0.90','1.10','1.20','1.30','1.40'],dtype=str)}  #b_list

SWCX_scale = {'MSWCX4':np.array(['1.45','1.46','1.47','1.48','1.49','1.51','1.52','1.53','1.54',\
                                  '2.50','3.00','3.50','4.00','4.50','5.00'],dtype=str),\
              'MSWCX5':np.array(['1.45','1.46','1.47','1.48','1.49','1.51','1.52','1.53','1.54',\
                                  '2.50','3.00','3.50','4.00','4.50','5.00'],dtype=str),\
              'MSWCX6':np.array(['2.60','2.70','2.80','2.90','3.10','3.20','3.30','3.40',\
                                '3.60','3.70','3.80','3.90','4.10','4.20','4.30','4.40'],dtype=str),\
              'MSWCX7':np.array(['1.60','1.70','1.80','1.90','3.10','3.20','3.30','3.40',\
                                '3.60','3.70','3.80','3.90','4.10','4.20','4.30','4.40'],dtype=str),\
              'MSWCX8':np.array(['1.25','1.26','1.27','1.28','1.29','1.31','1.32','1.33','1.34',\
                                '2.50','3.00','3.50','4.00','4.50','5.00'],dtype=str),\
              'MSWCX9':np.array(['0.60','0.70','0.80','0.90','2.10','2.20','2.30','2.40','2.60','2.70','2.80','2.90',\
                                '4.10','4.20','4.30','4.40'],dtype=str),\
              'MSWCX10':np.array(['1.15','1.16','1.17','1.18','1.19','1.21','1.22','1.23','1.24',\
                                  '2.50','3.00','3.50','4.00','4.50','5.00'],dtype=str)}  #c_list

SWCX_scale = {'MSWCX4':np.array(['2.60','2.70','2.80','2.90'],dtype=str),\
              'MSWCX5':np.array(['2.10','2.20','2.30','2.40'],dtype=str),\
              'MSWCX6':np.array(['3.65','3.66','3.67','3.68','3.69','3.71','3.72','3.73','3.74'],dtype=str),\
              'MSWCX7':np.array(['3.25','3.26','3.27','3.28','3.29','3.31','3.32','3.33','3.34'],dtype=str),\
              'MSWCX8':np.array(['3.10','3.20','3.30','3.40'],dtype=str),\
              'MSWCX9':np.array(['2.75','2.76','2.77','2.78','2.79','2.81','2.82','2.83','2.84'],dtype=str),\
              'MSWCX10':np.array(['1.25','1.26','1.27','1.28','1.29','3.60','3.70','3.80','3.90'],dtype=str)}  #d_list
'''
SWCX_scale = {'MSWCX6':np.array(['3.75','3.76','3.77','3.78','3.79'],dtype=str)}  #e_list             
#Model 1 Lists
    ...
    for OVII_Oratio in SWCX_scale[source_name]:        
        ...
        for i in range(len(spec_list)): #fit model to each spectrum linked between detectors        
            ...
            if (i==0):    
                ...
                SWCX_par[i] = {1:'0.44339,-1',2:'0.001,-1',3:'0.1,0.1,0.,0.02,0.2,10.',\
