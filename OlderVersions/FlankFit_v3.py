...
model_note = 'MSWCXFlanks_v3T9'+nH_type  #store choices, fit type
...
halo_pars={}
halo_file = DictReader(open(tail_dir+'MSWCXTails_v9'+nH_type+'.csv','r')) #*******************Tail version
    ...
    for i in range(len(spec_list)): #fit model to each spectrum linked between detectors        
        ...
        if (i==0):    
            xray_par[i]={1:'0.097,-1',2:'1,-1',3:'0,-1',4:LHB_target+',-1',\
                          ...
                          10:'1.45,-1',11:'0.38,-1'}
            SWCX_par[i] = {1:line_ints['Energy']['LowE']+',-1',2:'0.001,-1',3:'0.04,0.01,0.,0.,0.08,10.',\
                          4:line_ints['Energy']['O VIIa']+',-1',5:'0.001,-1',6:'0.04,0.01,0.,0.,0.08,10.',\
                          7:line_ints['Energy']['O VIIb']+',-1',8:'0.001,-1',9:'=SWCX:p6*'+OVII_ratio,\
                          10:line_ints['Energy']['O VIIIa']+',-1',11:'0.001,-1',12:'0.04,0.01,0.,0.,0.08,10.',\
                          13:line_ints['Energy']['O VIIIb']+',-1',14:'0.001,-1',15:'=SWCX:p12*'+OVIII_ratio,\
                          16:line_ints['Energy']['Ne IXa']+',-1',17:'0.001,-1',18:'0.04,0.01,0.,0.,0.08,10.',\
