...
v6: all except MgXI
v6best: change halo metallicity to 0.3
"""
...
source_list=np.array(('MSWCX1','MSWCX2','MSWCX3','MSWCX4','MSWCX5','MSWCX6','MSWCX7','MSWCX8','MSWCX9','MSWCX10','MSWCX11','MSWCX12'),dtype=str)
ID_list = np.array((68,69,70,71,72,73,74,75,76,77,78,79,372),dtype=int)
...
nH_type = '_nHPZ' #set type of nH used options: '_nHHI4pi', '_nHSFDW', '_nHPZ'
model_note = 'MSWCXTails_v6b'+nH_type  #store choices, fit type
...
t = pyfits.open(code_dir+'LHB_nH_ecl2.fits')  
...
NVI_ratio = str('{:.3f}'.format(float(line_ints['Average']['N VIb'])/float(line_ints['Average']['N VIa'])))
NVII_ratio = str('{:.3f}'.format(float(line_ints['Average']['N VIIb'])/float(line_ints['Average']['N VIIa'])))
OVII_ratio = str('{:.3f}'.format(float(line_ints['Average']['O VIIb'])/float(line_ints['Average']['O VIIa'])))
OVIII_ratio = str('{:.3f}'.format(float(line_ints['Average']['O VIIIb'])/float(line_ints['Average']['O VIIIa'])))
NeIX_ratio = str('{:.3f}'.format(float(line_ints['Average']['Ne IXb'])/float(line_ints['Average']['Ne IXa'])))
MgXI_ratio = str('{:.3f}'.format(float(line_ints['Average']['Mg XIb'])/float(line_ints['Average']['Mg XIa'])))

#absolute line ratios (relative to O VII)
SIX_Oratio = str('{:.3f}'.format(float(line_ints['Average']['S IX'])))
NVI_Oratio = str('{:.3f}'.format(float(line_ints['Average']['N VIa'])))
CVI_Oratio = str('{:.3f}'.format(float(line_ints['Average']['C VI'])))
NVII_Oratio = str('{:.3f}'.format(float(line_ints['Average']['N VIIa'])))
OVIII_Oratio = str('{:.3f}'.format(float(line_ints['Average']['O VIIIa'])))
NeIX_Oratio = str('{:.3f}'.format(float(line_ints['Average']['Ne IXa'])))
MgXI_Oratio = '0.'#str('{:.3f}'.format(float(line_ints['Average']['Mg XIa'])))  
...
for source_name in source_list:
    ...
    for i in range(len(spec_list)): #fit model to each spectrum linked between detectors        
        ...
        if (i==0):    
            xray_par[i]={1:'0.097,-1',2:'1,-1',3:'0,-1',4:LHB_target+',-1',\
                          5:nh_target+',-1',\
                          6:'0.2,0.1,0.01,0.15,0.3,3.',7:'0.3,-1',8:'0,-1',9:'1.0,0.1,0,0.1,1e20,1e24',\
                          10:'1.45,-1',11:'0.38,-1'}
            SWCX_par[i] = {1:line_ints['Energy']['S IX']+',-1',2:'0.001,-1',3:'=SWCX:p18*'+SIX_Oratio,\
                          4:line_ints['Energy']['N VIa']+',-1',5:'0.001,-1',6:'=SWCX:p18*'+NVI_Oratio,\
                          7:line_ints['Energy']['C VI']+',-1',8:'0.001,-1',9:'=SWCX:p18*'+CVI_Oratio,\
                          10:line_ints['Energy']['N VIb']+',-1',11:'0.001,-1',12:'=SWCX:p6*'+NVI_ratio,\
                          13:line_ints['Energy']['N VIIa']+',-1',14:'0.001,-1',15:'=SWCX:p18*'+NVII_Oratio,\
                          16:line_ints['Energy']['O VIIa']+',-1',17:'0.001,-1',18:'0.1,0.1,0,0,1e+20,1e+20',\
                          19:line_ints['Energy']['O VIIb']+',-1',20:'0.001,-1',21:'=SWCX:p18*'+OVII_ratio,\
                          22:line_ints['Energy']['N VIIb']+',-1',23:'0.001,-1',24:'=SWCX:p15*'+NVII_ratio,\
                          25:line_ints['Energy']['O VIIIa']+',-1',26:'0.001,-1',27:'=SWCX:p18*'+OVIII_Oratio,\
                          28:line_ints['Energy']['O VIIIb']+',-1',29:'0.001,-1',30:'=SWCX:p27*'+OVIII_ratio,\
                          31:line_ints['Energy']['Ne IXa']+',-1',32:'0.001,-1',33:'=SWCX:p18*'+NeIX_Oratio,\
                          34:line_ints['Energy']['Ne IXb']+',-1',35:'0.001,-1',36:'=SWCX:p33*'+NeIX_ratio,\
                          37:line_ints['Energy']['Mg XIa']+',-1',38:'0.001,-1',39:'=SWCX:p18*'+MgXI_Oratio,\
                          40:line_ints['Energy']['Mg XIb']+',-1',41:'0.001,-1',42:'=SWCX:p39*'+MgXI_ratio}
        else: 
            xray_par[i]={1:'0.097,-1',2:'1,-1',3:'0,-1',4:LHB_target+',-1',\
                          5:nh_target+',-1',\
                          6:'=Xray:p6',7:'=Xray:p7',8:'0,-1',9:'=Xray:p9',\
                          10:'1.45,-1',11:'0.38,-1'}      
            SWCX_par[i] = {1:line_ints['Energy']['S IX']+',-1',2:'0.001,-1',3:'=SWCX:p3',\
                          4:line_ints['Energy']['N VIa']+',-1',5:'0.001,-1',6:'=SWCX:p6',\
                          7:line_ints['Energy']['C VI']+',-1',8:'0.001,-1',9:'=SWCX:p9',\
                          10:line_ints['Energy']['N VIb']+',-1',11:'0.001,-1',12:'=SWCX:p12',\
                          13:line_ints['Energy']['N VIIa']+',-1',14:'0.001,-1',15:'=SWCX:p15',\
                          16:line_ints['Energy']['O VIIa']+',-1',17:'0.001,-1',18:'=SWCX:p18',\
                          19:line_ints['Energy']['O VIIb']+',-1',20:'0.001,-1',21:'=SWCX:p21',\
                          22:line_ints['Energy']['N VIIb']+',-1',23:'0.001,-1',24:'=SWCX:p24',\
                          25:line_ints['Energy']['O VIIIa']+',-1',26:'0.001,-1',27:'=SWCX:p27',\
                          28:line_ints['Energy']['O VIIIb']+',-1',29:'0.001,-1',30:'=SWCX:p30',\
                          31:line_ints['Energy']['Ne IXa']+',-1',32:'0.001,-1',33:'=SWCX:p33',\
                          34:line_ints['Energy']['Ne IXb']+',-1',35:'0.001,-1',36:'=SWCX:p36',\
                          37:line_ints['Energy']['Mg XIa']+',-1',38:'0.001,-1',39:'=SWCX:p39',\
                          40:line_ints['Energy']['Mg XIb']+',-1',41:'0.001,-1',42:'=SWCX:p42'}
    #set names for parameters
    xray_names={6:'Halo_kT',9:'Halo_N'}
    SWCX_names={18:'SWCX_OVII'}    
    ...
    SWCX_model=xs.Model('gauss+gauss+gauss+gauss+gauss+gauss+gauss+gauss+gauss+gauss+gauss+gauss+gauss+gauss','SWCX',3)
    ...
    for i, j in itertools.product(range(len(spec_list)), range(smodel[i].nParameters)):
        if not ((smodel[i](j+1).frozen)or(len(smodel[i](j+1).link)>0)):
            ...
            xs.Fit.steppar('best SWCX:'+str(parnum)+' 0.0001 0.1 25')                          
