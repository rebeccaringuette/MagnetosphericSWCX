...
source_list=np.array(('MSWCX3','MSWCX4'),dtype=str)
ID_list = np.array((70,71),dtype=int)
...
model_note = 'MSWCXTailHot_v2'+nH_type  #store choices, fit type
    ...
    for i in range(len(spec_list)): #fit model to each spectrum linked between detectors        
        ...
        if (i==0):    
            xray_par[i]={1:'0.097,-1',2:'1,-1',3:'0,-1',4:LHB_target+',-1',\
                          5:nh_target+',-1',\
                          6:'0.2,0.02,0.1,0.15,0.3,0.35',7:'0.3,-1',8:'0,-1',9:'1.0,0.1,0,0.1,1e20,1e24',\
                          10:'1.45,-1',11:'0.38,-1',\
