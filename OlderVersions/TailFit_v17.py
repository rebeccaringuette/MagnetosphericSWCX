...
source_list=np.array(['HS0071','HS0072','HS0073','HS0074','HS0075','HS0076','HS0077'],dtype=str) 
...
model_note = 'MSWCXTails_v17'+nH_type+'_mod2'  #store choices, fit type
...
SWCX_LU = {}
SWCX_file = DictReader(open(code_dir+'NewHelioMSWCX.csv','r'))
