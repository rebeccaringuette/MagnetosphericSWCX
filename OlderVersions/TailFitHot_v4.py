...
source_list=np.array(('MSWCX1','MSWCX2','MSWCX3','MSWCX4','MSWCX5','MSWCX8','MSWCX9','MSWCX10','MSWCX11','MSWCX12'),dtype=str) #done:   #Need SWCX: 'MSWCX6','MSWCX7',
ID_list = np.array((68,69,70,71,72,75,76,77,78,79),dtype=int) #done:    #Need SWCX: 73,74
...
model_note = 'MSWCXTailHot_v4'+nH_type  #store choices, fit type
halo_kT1 = 0.2086  #+/- 0.0049 keV
...
SWCX_LU = {}
SWCX_file = DictReader(open(code_dir+'MSWCX_helioSWCXcalc.csv','r'))
...
for source_name in source_list:
    ...
    spec_list=np.sort(glob.glob(spec_dir+source_name+'_*_rebinc40.pi'))      #get file names
    ...
    idx = np.where((SWCX_LU['MSWCX#']==source_name) & (SWCX_LU['ObsName']==obsname))[0] 
    ...
    for i in range(len(spec_list)): #fit model to each spectrum linked between detectors        
        ...
        if (i==0):    
            xray_par[i]={1:'0.097,-1',2:'1,-1',3:'0,-1',4:LHB_target+',-1',\
                          5:nh_target+',-1',\
                          6:str(halo_kT1)+',-1',7:'0.3,-1',8:'0,-1',9:'1.0,0.1,0,0.1,1e20,1e24',\
                          10:'1.45,-1',11:'0.38,-1',\
