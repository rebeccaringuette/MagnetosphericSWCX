...
source_list=np.array(('MSWCX8','MSWCX9','MSWCX10','MSWCX11','MSWCX12'),dtype=str) #done: 'MSWCX1','MSWCX2','MSWCX3','MSWCX4','MSWCX5',  #Need SWCX: 'MSWCX6','MSWCX7',
ID_list = np.array((75,76,77,78,79),dtype=int) #done: 68,69,70,71,72,   #Need SWCX: 73,74
...
model_note = 'MSWCXTailHot_v3'+nH_type  #store choices, fit type
