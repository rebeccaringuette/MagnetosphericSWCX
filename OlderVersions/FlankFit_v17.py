...
skip_list = ['HS0068','HS0069','HS0070','HS0078','HS0079']  #don't have HSWCX calcs for these yet
...
mod_choice = '2'
model_note = 'MSWCXFlanks_v17'+nH_type+'_mod'+mod_choice  #store choices, fit type
...
halo_pars={}
halo_file = DictReader(open(out_dir+'Master_MSWCXTails_v17'+nH_type+'_mod2.csv','r')) #*******************Tail version
