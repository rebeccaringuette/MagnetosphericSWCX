...
out_dir ='/home/ringuette/halosat_sourceanalysis/MSWCX_2020Analysis/FlankOut/'
...
model_note = 'MSWCXFlanks_v2T6'+nH_type  #store choices, fit type
...
#get list of flank obs
idx = np.where(bkg_pi['ObsType']=='flank')[0]  
obs_list, MSWCX_list, flank_list = bkg_pi['ObsName'][idx], bkg_pi['MSWCX#'][idx],[]
for i in idx: flank_list.append(bkg_pi['MSWCX#'][i]+'_'+bkg_pi['ObsName'][i])
  
#read halo pars for each MSWCX target
halo_pars={}
halo_file = DictReader(open(tail_dir+'MSWCXTails_v6'+nH_type+'.csv','r')) #*******************Tail version
...
for source_name in flank_list:
    ...
    for i in range(len(spec_list)): #fit model to each spectrum linked between detectors        
        ...
        if (i==0):    
            xray_par[i]={1:'0.097,-1',2:'1,-1',3:'0,-1',4:LHB_target+',-1',\
                          5:nh_target+',-1',\
                          6:str(halo_kT)+',-1',7:'1,-1',8:'0,-1',9:str(halo_N)+',-1',\
                          10:'1.45,-1',11:'0.38,-1'}
            SWCX_par[i] = {1:line_ints['Energy']['S IX']+',-1',2:'0.001,-1',3:'0.1,0.1,0,0,1e+20,1e+20',\
                          4:line_ints['Energy']['N VIa']+',-1',5:'0.001,-1',6:'0.1,0.1,0,0,1e+20,1e+20',\
                          7:line_ints['Energy']['C VI']+',-1',8:'0.001,-1',9:'0.1,0.1,0,0,1e+20,1e+20',\
                          10:line_ints['Energy']['N VIb']+',-1',11:'0.001,-1',12:'=SWCX:p6*'+NVI_ratio,\
                          13:line_ints['Energy']['N VIIa']+',-1',14:'0.001,-1',15:'0.1,0.1,0,0,1e+20,1e+20',\
                          ...
                          25:line_ints['Energy']['O VIIIa']+',-1',26:'0.001,-1',27:'0.1,0.1,0,0,1e+20,1e+20',\
                          28:line_ints['Energy']['O VIIIb']+',-1',29:'0.001,-1',30:'=SWCX:p27*'+OVIII_ratio,\
                          31:line_ints['Energy']['Ne IXa']+',-1',32:'0.001,-1',33:'0.1,0.1,0,0,1e+20,1e+20',\
                          34:line_ints['Energy']['Ne IXb']+',-1',35:'0.001,-1',36:'=SWCX:p33*'+NeIX_ratio,\
                          37:line_ints['Energy']['Mg XIa']+',-1',38:'0.001,-1',39:'0.1,0.1,0,0,1e+20,1e+20',\
                          40:line_ints['Energy']['Mg XIb']+',-1',41:'0.001,-1',42:'=SWCX:p39*'+MgXI_ratio}
        else: 
            xray_par[i]={1:'0.097,-1',2:'1,-1',3:'0,-1',4:LHB_target+',-1',\
                          5:nh_target+',-1',\
                          6:'=Xray:p6',7:'1,-1',8:'0,-1',9:'=Xray:p9',\
                          10:'1.45,-1',11:'0.38,-1'}      
    ...
    SWCX_names={18:'SWCX_OVII',3:'SWCX_SIX',6:'SWCX_NVI',9:'SWCX_CVI',15:'SWCX_NVII',\
                27:'SWCX_OVIII',33:'SWCX_NeIX',39:'SWCX_MgIX'}    
    ...
    for i, j in itertools.product(range(len(spec_list)), range(smodel[i].nParameters)):
        if not ((smodel[i](j+1).frozen)or(len(smodel[i](j+1).link)>0)):
            ...
            if source_name==flank_list[0]:  #first key
    ...
    if source_name==flank_list[0]: #initialize csv file header
