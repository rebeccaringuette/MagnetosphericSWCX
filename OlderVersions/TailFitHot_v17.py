...
source_list=np.array(['HS0071','HS0072','HS0073','HS0074','HS0075','HS0076','HS0077'],dtype=str)  #,'HS0072','HS0073','HS0074','HS0075','HS0076','HS0077'
...
mod_choice = '2'
model_note = 'MSWCXTailsHot_v17'+nH_type+'_mod'+mod_choice  #store choices, fit type
...
SWCX_LU = {}
SWCX_file = DictReader(open(code_dir+'helioMSWCX.csv','r'))
...
for source_name in source_list:
	...
	OVII_N = float(SWCX_LU['OVII_'+mod_choice][idx][0])*0.035
	OVIII_N = float(SWCX_LU['OVIII_'+mod_choice][idx][0])*0.035
	NeIX_N = float(SWCX_LU['NeIX_'+mod_choice][idx][0])*0.035  
