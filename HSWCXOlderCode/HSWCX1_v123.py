...
#halo_kT1, halo_N1 = 0.270, 0.680  #v116 values
#halo_kT2, halo_N2 = 0.993, 0.259  #v116 values
#halo_kT1, halo_N1 = 0.270, 0.678  #v116a values
#halo_kT2, halo_N2 = 0.992, 0.258  #v116a values
#halo_kT1, halo_N1 = 0.280, 0.671  #v116aG2 values
#halo_kT2, halo_N2 = 1.037, 0.257  #v116aG2 values
halo_kT1, halo_N1 = 0.275, 0.684  #v122 values
halo_kT2, halo_N2 = 1.020, 0.255  #v122 values
...
#SWCX line ratios
OVII_ratio = '0.126'
OVIII_ratio = '0.320'  #choose He ratio since through He-cone  (100% He - 0.549, 100% H - 0.320)
NeIX_ratio = '0.100'
...
key_list = ['GOOD2','Oct2018a+','Oct2018b+','Nov2018a+','Nov2018b+','Dec2018','Feb2019','Mar2019','Sep2019','Oct2019',\
...
for key in key_list:
    ...
    for i in range(len(spec_list)): #fit model to each spectrum linked between detectors    
        ...
        if (i==0):    
            ...
            SWCX_par[i] = {1:line_ints['Energy']['LowE']+',-1',2:'0.001,-1',3:'0.035,0.01,0.,0.,0.06,10.',\
