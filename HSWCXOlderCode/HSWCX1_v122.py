...
SWCX_LU = {}
SWCX_file = DictReader(open(code_dir+'HSWCXcalc.csv','r'))
...
fixed_pars={'Oct2018+':[(LHB[366]*12224.5+LHB[367]*28934.0)/(12224.5+28934.0),\
            ...
            'Sep2019':[LHB[65],nh[65]],'Oct2019':[LHB[65],nh[65]],\
             ...
             'GOOD2':[LHB[65],nh[65]]}
key_list = ['GOOD2']#,'Oct2018b+','Nov2018b+','Oct2019','Nov2019+','Nov2019','Dec2019+','Dec2019']  #for running with SWCX fixed
...
for key in key_list:
    ...
    OVII_N, OVIII_N, NeIX_N = float(SWCX_LU['OVII_Mod3'][idx][0])*0.035, float(SWCX_LU['OVIII_Mod3'][idx][0])*0.035, \
          float(SWCX_LU['NeIX_Mod3'][idx][0])*0.035
