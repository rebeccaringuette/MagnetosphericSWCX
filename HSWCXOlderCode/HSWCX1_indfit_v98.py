...
#TTS_N = 0.097157   #v98a: absorbed v96a, TTS_T1 = 0.5
#TTS_N = 0.0454    #v98b: unabsorbed v96a, TTS_T1 = 0.5
TTS_T1, TTS_N = 0.831, 0.050887    #v98c: values from v99a
    ...
    for i in range(len(spec_list)): #fit model to each spectrum linked between detectors    
        ...
        if (i==0):    
            ...
            SWCX_par[i]={1:line_ints['Energy']['LowE']+',-1',2:'0.001,-1',3:'0.,-1',\
                          ...
                          10:line_ints['Energy']['O VIIIa']+',-1',11:'0.001,-1',12:'0.02,0.01,0.,0.,0.03,0.07',\
                          13:line_ints['Energy']['O VIIIb']+',-1',14:'0.001,-1',15:'=SWCX:p12*'+OVIII_ratio,\
                          16:line_ints['Energy']['Ne IXa']+',-1',17:'0.001,-1',18:'0.02,0.01,0.,0.,0.03,0.07',\
                          19:line_ints['Energy']['Ne IXb']+',-1',20:'0.001,-1',21:'=SWCX:p18*'+NeIX_ratio}
            TTS_par[i]={1:'0.,-1',\
                          2:str(TTS_T1)+',-1',3:'1.,-1',4:'0,-1',5:str(TTS_N)+',-1',\
                          6:'2.07,-1',7:'1.,-1',8:'0,-1',9:'=TTS:p5'}  #'0.1,0.1,0.,0.,0.5,1.
        else: 
