...
v97a: TTS_N fixed to v96a absorbed value
v97b: TTS_N fixed to v96a unabsorbed value
v97c: TTS_T1 and TTS_N fixed to v99 values (unabsorbed)
"""
...
#TTS_N = 0.097157   #v97a: absorbed v96a, TTS_T1 = 0.5
#TTS_N = 0.0454    #v97b: unabsorbed v96a, TTS_T1 = 0.5
TTS_T1, TTS_N = 0.831, 0.050887    #v97c: values from v99a
...
for key in key_list:
    ...
    LowE_Oratio = str('{:.3f}'.format(float(line_ints[key]['LowE'])))
    ...
    for i in range(len(spec_list)): #fit model to each spectrum linked between detectors    
        ...
        if (i==0):    
            ...
            SWCX_par[i]={1:line_ints['Energy']['LowE']+',-1',2:'0.001,-1',3:'0.,-1',\
                          4:line_ints['Energy']['O VIIa']+',-1',5:'0.001,-1',6:'0.02,0.01,0.,0.,0.03,0.07',\
            ...
            TTS_par[i]={1:'0.,-1',\
                          ...
                          6:'2.07,-1',7:'1.,-1',8:'0,-1',9:'=TTS:p5'}  #',0.1,0.,0.,0.5,1.',
        else: 
