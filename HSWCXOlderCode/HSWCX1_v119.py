...
halo_kT1, halo_N1 = 0.270, 0.680
halo_kT2, halo_N2 = 0.993, 0.259
...
#key_list = ['GOOD','Oct2018+','Oct2018b+','Nov2018+','Dec2018','Feb2019','Sep2019','Oct2019',\
#            'Nov2019+','Nov2019','Dec2019+','Dec2019','Jan2020+','Feb2020+','Mar2020+']
key_list = ['GOOD','Oct2018b+','Nov2018+','Oct2019','Nov2019+','Nov2019','Dec2019+','Dec2019']  #good list only
#key_list = ['Dec2019+']
#key_list=['GOOD']
...
for key in key_list:
    ...
    LowE_N = OVII_N*float(LowE_ratio)  #fix LowE_N relative to calculated O VII line.
