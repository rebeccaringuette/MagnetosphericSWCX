...
halo_kT1, halo_N1 = 0.776, 0.308
halo_kT2, halo_N2 = 0.272, 0.074
...
NeIX_ratio = '0.100'
LowE_ratios = ['0.','0.46732','0.93463','1.40195','1.86926']
...
#loop through LowE_N values
for N in range(len(LowE_ratios)):
    LowE_ratio = LowE_ratios[N]
    LowE_type = '_'+str(N)
