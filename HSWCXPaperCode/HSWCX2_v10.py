...
v9: same as v7, using Model 3, with N2=0 for comparison
v10: same as v6, using halo results from best fit scaling factor (v7_0f)
"""
...
model_note = nH_type+'OVII_0f'  #store choices, fit type
CXB_PI, CXB_N = 1.45, 0.382   #Capellutti et al. 2017
halo_kT1, halo_N1 = 0.262, 1.21   
halo_kT2, halo_N2 = 1.03, 0.126     
...
key_list = ['Dec2018','Dec2019a','Dec2019bc','Dec2019d','Feb2020']  #HSWCX2 observations
    ...
    for i in range(len(spec_list)): #fit model to each spectrum linked between detectors    
        ...
        if (i==0):    
            ...
            SWCX_par[i] = {1:'0.44339,-1',2:'0.001,-1',3:'0.035,0.01,0.,0.,0.06,10.',\
                          ...
                          10:'0.65310,-1',11:'0.001,-1',12:'0.035,0.01,0.,0.,0.06,10.',\
                          13:'0.80308,-1',14:'0.001,-1',15:'=SWCX:p12*'+OVIII_ratio,\
                          16:'0.90873,-1',17:'0.001,-1',18:'0.035,0.01,0.,0.,0.06,10.',\
