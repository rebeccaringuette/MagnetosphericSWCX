...
prefix = 'HSWCX1v132' #default is SWAN-based HSWCX calcs (model 3)
HSWCXmod = '1'   #3 for SWAN-based calcs

#define options
#OVII_list = np.array(['0.50','0.60','0.70','0.80','0.90','1.00','1.05','1.06','1.07','1.10','1.20','1.30','1.40','1.50','1.60'],dtype=str) #a list 
OVII_list = np.array(['1.08','1.09','1.11','1.12','1.13','1.14','1.15'],dtype=str) #b list 
CXB_PI, CXB_N = 1.45, 0.382
nH_type = '_nHKip' #set type of nH used options: '_nHRT', '_nHHI4pi', '_nHSFDW', '_nHPZ'
model_note = nH_type+'OVII_b'
...
key_list = ['GOODH1']#['ALL06H1','GOODH1']#,'Oct2018b+','Nov2018b+','Oct2019','Nov2019+','Nov2019','Dec2019+','Dec2019']  #for running with SWCX fixed
...
for OVII_Oratio in OVII_list:
    ...
    for key in key_list:
        ...
        if (OVII_Oratio==OVII_list[0]) and (key==key_list[0]): #initialize csv file header
            ...
            chi_file.close()        
        #print OVII_Oratio, key, file_format, halo_arr
