...
out_dir=spec_dir
prefix = 'HSWCX1v130h2'   #h0: OVIIscale=1, h1: OVIIscale=0.5, h2: OVIIscale=1.5
OVIIscale='1.5'

#halo results
#halo_kT1, halo_N1 = 0.248, 0.834  #OVIIscale=1
#halo_kT2, halo_N2 = 0.973, 0.240  
#halo_kT1, halo_N1 = 0.211, 1.25  #OVIIscale=0.5
#halo_kT2, halo_N2 = 0.932, 0.265  #
halo_kT1, halo_N1 = 0.299, 0.537  #OVIIscale=1.5
halo_kT2, halo_N2 = 0.965, 0.226  #
