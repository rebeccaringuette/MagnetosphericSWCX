...
prefix = 'HSWCX1v131' #default is SWAN-based HSWCX calcs (model 3)
HSWCXmod = '3'   #3 for SWAN-based calcs

#OVII_list = np.array(['1.00','0.85','0.75','0.70','0.50'],dtype=str) #original list
#OVII_list = np.array(['1.15','1.25','1.50'],dtype=str) #b list
#OVII_list = np.array(['0.25','0.00','1.75','2.00'],dtype=str) #c list
#OVII_list = np.array(['1.05','1.10','1.40','0.60'],dtype=str) #d list
#OVII_list = np.array(['1.03','1.04','1.06','1.07','1.08','1.09'],dtype=str) #e list
#OVII_list = np.array(['1.055','1.065'],dtype=str) #f list  
#OVII_list = np.array(['1.0625','1.060','1.065'],dtype=str) #g list  
OVII_list = np.array(['1.06'],dtype=str) #h list, using ALL06H1 and GOODH1
...
fixed_pars={'Oct2018+':[(LHB[366]*12224.5+LHB[367]*28934.0)/(12224.5+28934.0),\
            ...
            'Sep2019':[LHB[65],nh[65]],'Oct2019':[LHB[65],nh[65]],\
             ...
             'GOOD2':[LHB[65],nh[65]],'GOODH1':[LHB[65],nh[65]],\
             'ALL06H1':[LHB[65],nh[65]],'3MTHLOW':[LHB[65],nh[65]]}
key_list = ['ALL06H1','GOODH1']#,'Oct2018b+','Nov2018b+','Oct2019','Nov2019+','Nov2019','Dec2019+','Dec2019']  #for running with SWCX fixed
...
for OVII_Oratio in OVII_list:
    ...
    file_format='\n{0[0]},{0[1]:.6f},{0[2]:.3f}'
    csv_num=3  #next number in []
    model_note = nH_type+'OVII_'+str(np.where(OVII_list==OVII_Oratio)[0][0])+'h'
