...
prefix = 'HSWCX2v7' #default is SWAN-based HSWCX calcs (model 3)
HSWCXmod = '3'   #3 for SWAN-based calcs
        
#define options
#OVII_list = np.array(['0.50','0.75','0.90','0.95','1.00','1.05','1.10','1.25','1.50'],dtype=str) #a list
#OVII_list = np.array(['2.00','2.50','3.00','3.50','4.00'],dtype=str) #b list
#OVII_list = np.array(['4.50','5.00','5.50','6.00','6.50'],dtype=str) #c list
#OVII_list = np.array(['3.60','3.70','3.80','3.90','4.10','4.20'],dtype=str) #d list
#OVII_list = np.array(['3.75','3.76','3.77','3.78','3.79','3.81','3.82','3.83','3.84','3.85'],dtype=str) #e list
OVII_list = np.array(['3.80'],dtype=str) #f list, using both ALL06H2 and GOODH2
nH_type = '_nHKip' #set type of nH used options: '_nHLAB', '_nHHI4pi', '_nHSFDW', '_nHPZ'
#model_note = nH_type  #store choices, fit type
...
key_list = ['ALL06H2','GOODH2']#'Dec2018','Dec2019a','Dec2019bc','Dec2019d','Feb2020']  #HSWCX2 observations
...
for OVII_Oratio in OVII_list:
    ...
    model_note = nH_type+'OVII'+str(np.where(OVII_list==OVII_Oratio)[0][0])+'f'
