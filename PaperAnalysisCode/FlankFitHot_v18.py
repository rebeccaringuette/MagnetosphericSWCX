...
skip_list = ['HS0068','HS0069','HS0071','HS0072','HS0074','HS0075','HS0076','HS0077','HS0078','HS0079']  #these have hot thermal components in the tail spectra
...
model_note = 'MSWCXFlanksHot_v18'+nH_type+'_mod2'  #store choices, fit type
...
halo_pars={}
halo_file = DictReader(open(out_dir+'MSWCXTailsHot_v18'+nH_type+'_mod2.csv','r')) #*******************Tail version
...
for obsname in flank_names:
	...
	if source_name in skip_list: continue  #skip targets not ready yet
	...
	halo_kT1, halo_N1 = float(halo_pars['halo_kT1'][idx]), float(halo_pars['halo_N1'][idx])
	halo_kT2, halo_N2 = float(halo_pars['halo_kT2'][idx]), float(halo_pars['halo_N2'][idx])
	#print(obsname, halo_kT1, halo_N1, halo_kT2, halo_N2)
	#stop
	#store values
	halo_arr=[obsname,RA[source_idx][0],DEC[source_idx][0],glon[source_idx][0],glat[source_idx][0],\
		LHB[source_idx][0],nh[source_idx][0], halo_kT1, halo_N1, halo_kT2, halo_N2]
	...
	#run steppar on all free xray parameters (none are free)
